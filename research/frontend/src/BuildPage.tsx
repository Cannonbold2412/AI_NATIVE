...
export function BuildPage() {
  ...
  const [buildResult, setBuildResult] = useState<PluginBuildStreamResult | null>(null)
  ...
  async function handleBuild() {
    ...
    try {
      ...
      const result = await readPluginSse<PluginBuildStreamResult>(response, (msg) => {
